    ...
    <div className="min-h-screen bg-slate-100 flex flex-col selection:bg-teal-700 selection:text-white">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
          ...
          <div className="bg-white p-4 rounded-2xl border border-teal-200 bg-teal-50/40 shadow-xs col-span-2 sm:col-span-1 flex flex-col justify-between">
              ...
              <div className="pt-2 border-t border-slate-200 flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    title="Download Official Appointment Confirmation PDF"
                  >
